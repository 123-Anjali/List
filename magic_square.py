...
while i<len(magic_square):
    j=0
    while j<len(magic_square):
        col_sum=col_sum+magic_square[i][j]
        j=j+1
    i=i+1
print(col_sum)
print()
...
if row_sum==col_sum and left_diagonal==right_diagonal:
    print("it is a magic_square",row_sum,col_sum,left_diagonal,right_diagonal)
else:
    print("it is not magic_square",row_sum,col_sum,left_diagonal,right_diagonal)
